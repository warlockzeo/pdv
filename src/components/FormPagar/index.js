                ...
                <div className='modal-dialog modal-dialog-centered'>
                    <div className='modal-content'>
                        ...
                        <div className='modal-body'>
                            <form className='modalForm__form'>
                                <div className='col-md-12 modalForm__nome'>
                                    ...
                                    <span>Saldo atual: {saldo}</span><br />
                                    <label>Valor:</label>
                                    <input className='form-control' type='text' id='valor' defaultValue='0,00' />
                                </div>
                        ...
                        <div className='modal-footer'>
                            <button type='button' className='btn btn-success' data-dismiss='modal' onClick={this.pagar}>Pagar</button>
