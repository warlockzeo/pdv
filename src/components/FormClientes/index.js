...
const mes =
  hoje.getMonth() < 9 ? `0${hoje.getMonth() + 1}` : hoje.getMonth() + 1;
...
class FormClientes extends Component {
  ...
  render() {
    ...
    const { id, nome, endereco, fone, cpf, rg, complemento } =
      this.props.dados || '';

    const dataSaldo = this.props.dados
      ? this.props.dados.dataSaldo !== null
        ? this.props.dados.dataSaldo
        : dataHoje
      : dataHoje;
            ...
            <div className='modal-body'>
              <form className='modalForm__form'>
                ...
                <div className='col-md-6 modalForm__saldo'>
                  <label>Saldo:</label>
                  <input
                    className='form-control input-saldo'
                    type='text'
                    id='saldo'
                    placeholder='Saldo'
                    defaultValue={saldo}
                ...
                <div className='col-md-6 modalForm__dataSaldo'>
                  ...
                  <input
                    className='form-control input-dataSaldo'
                    type='date'
                    id='dataSaldo'
                    placeholder='Data do Saldo'
                    defaultValue={dataSaldo}
                    onChange={this.onChangeInput}
                  />
                </div>
                <div className='col-md-12 modalForm__complemento'>
                  ...
                  <input
                    className='form-control input-complemento'
                    type='text'
                    id='complemento'
