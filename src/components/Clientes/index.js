        ...
        return(
            <Fragment>
                ...
                <td className='text-right'>
                    <Button color='info' data-toggle='modal' data-target='#modalForm' onClick={this.onClickAtualizar}><span className='d-xs-none'>Editar</span> <i className='far fa-eye d-sm-none'></i></Button>&nbsp;
