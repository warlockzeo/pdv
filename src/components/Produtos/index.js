...
class Produtos extends Component {
    ...
    render() {
        ...
        return(
            <Fragment>
                <td style={{flex:'0 1 45%'}} className='text-left'>{produto.descr}</td>
                <td style={{flex:'10%'}} className='d-xs-none text-left'>{produto.estoque}</td>
                <td style={{flex:'10%'}} className='d-xs-none text-right'>{produto.preco}</td>
